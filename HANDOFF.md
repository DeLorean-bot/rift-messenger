...
2. Добавить bounded ICE restart/reconnect. Сейчас есть только grace period.
3. Message delivery state/retry, typing indicator, edit/delete/reply/reactions (по roadmap Buzz).
